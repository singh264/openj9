...
bool
TR::CompilationInfoPerThreadBase::isCompilingRestrictedMethod(TR::CompilationInfoPerThreadBase *compilationInfo, TR_ResolvedMethod *compilee, CompileParameters *compileParameters, TR_FilterBST *&filterInfo, TR_OpaqueMethodBlock *method)
   {
...
TR::CompilationInfoPerThreadBase::createCompilee(TR::CompilationInfoPerThreadBase *compilationInfo, CompileParameters *compileParameters, TR::IlGeneratorMethodDetails &methodDetails, TR_FilterBST *&filterInfo)
   {
      ...
      if (isCompilingRestrictedMethod(compilationInfo, compilee, compileParameters, filterInfo, method) || isCompilingWithExcessiveCacheSize(compilationInfo, compileParameters))
         {
         compilee = 0;
         }
